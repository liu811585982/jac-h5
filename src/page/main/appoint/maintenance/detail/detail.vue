    ...
    <div class="page-panel">
        ...
        <view-box ref="viewBox">
            <group title="基本信息" label-width="5em" label-margin-right="2em">
                ...
                <cell title="维保里程" :value="appointInfo.maintenanceMil ? appointInfo.maintenanceMil + 'km' : ''"></cell>
                ...
                <cell title="核销劵" :value="appointInfo.discounts"></cell>
                <cell title="维保项" :value="appointInfo.items" align-items="flex-start"></cell>
            ...
            <group title="维保费用" label-width="5em" label-margin-right="2em">
                <cell title="费用合计" :value="appointInfo.actualCost ? appointInfo.actualCost + '元' : ''"></cell>
                <cell title="抵扣金额" :value="appointInfo.deduction ? appointInfo.deduction + '元' : ''"></cell>
                <cell title="实付金额" :value="appointInfo.totalCost ? appointInfo.totalCost + '元' : ''"></cell>
            ...
            <group title="日期" label-width="5em" label-margin-right="2em">
                <cell title="维保日期" :value="appointInfo.actionTime"></cell>
                <cell title="交车日期" :value="appointInfo.overTime"></cell>
            </group>
            <group label-width="5em" label-margin-right="2em" class="mb-25">
                <cell title="备注" align-items="flex-start">
                    <slot>
                        <div class="text-left">{{appointInfo.note}}</div>
                    </slot>
                </cell>
            </group>
        </view-box>
